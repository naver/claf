...
class SeqTokClsBertDataset(DatasetBase):
    """
    Dataset for Sequence and Token Classification using BERT
    ...
    * Kwargs:
    ...
    def __init__(self, batch, helper=None):
        super(SeqTokClsBertDataset, self).__init__()

        self.name = "seq_tok_cls_bert"
        self.helper = helper
    ...
    def collate_fn(self, cuda_device_id=None):
        ...
        def make_tensor_fn(data):
            data_idxs, bert_input_idxs, token_type_idxs, tagged_token_idxs, num_tokens, class_idxs, tag_idxs_list = zip(*data)
    ...
    def get_ground_truth(self, data_id):
        return self.classes[data_id], self.tags[data_id]
